...
const REFUND_EXAMPLE = {
    id: "123",
    username: "Bruno A Sousa",
    category: CATEGORIES["transport"].name,
    amount: formatCurrency(23.5),
...
export function Dashboard(){
    ...
    function handlePagination(action: "next" | "previous"){
        setPage((currentPage) => {
            if(action === "next" && currentPage < totalOfPage){
    ...
    return (
        <div className="bg-gray-500 rounded-xl p-10 md:min-w-[768px]">
            ...
            >
                ...
                <Button type="submit" variant="icon" isLoading>
            ...
            <div className="my-6 flex flex-col gap-4 max-h-[342px] overflow-y-scroll">
                { refunds.map((refund) => <RefundItem key={refund.id} data={REFUND_EXAMPLE} href={`/refund/${refund.id}`}/>) }
            </div>
